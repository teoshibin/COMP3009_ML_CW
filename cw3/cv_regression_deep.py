...
class Logger(object):
    def __init__(self):
        ...
        self.log = open("regression_deeper.log", "w")
...
def myModel(weight_decay = 0.03, rate = 0.9):
    #Network parameters
    n_input = 8
    n_hidden = 12
    n_hidden1 = 24
    ...
    # Define Network
    input_layer, w1 = one_layer_perceptron(X, n_input, n_hidden, "relu")
    layer, w2 = one_layer_perceptron(input_layer, n_hidden, n_hidden1, "relu")
    relu_layer_dropout = tf.nn.dropout(layer, rate)
    layer_1, w3 = one_layer_perceptron(relu_layer_dropout, n_hidden1, n_hidden2, "relu")
    layer_2, w4 = one_layer_perceptron(layer_1, n_hidden2, n_hidden3, "relu")
    neural_network, w5 = one_layer_perceptron(layer_2, n_hidden3, n_output, "none")
